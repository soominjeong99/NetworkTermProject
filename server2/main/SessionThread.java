...
import server2.strategy.ServerBingoPlate;
...
public class SessionThread extends Thread {
    ...
    private ServerBingoPlate bingoPlate;
    ...
    SessionThread(Socket socket, List<Socket> socketList, List<SessionThread> sessionThreadList, CheckThread checkThread) {
        ...
        bingoPlate = new ServerBingoPlate();
                ...
                switch (type) {
                    ...
                    case ConstantProtocol.STONE_LOCATION:
                        ...
                        if (myTurn) {
                            ...
                            bingoPlate.putStone(row, col, stoneColor);
                            
                            
                            if (bingoPlate.winCheck(row, col)) {
                                broadcast(data, type);
                                sendWinInfo();
                                Thread.sleep(100);
